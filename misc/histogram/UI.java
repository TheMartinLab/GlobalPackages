...
public class UI extends JFrame {
	...
	private boolean bool_binsInX = false, bool_binsInY = false;
	...
	private JPanel setup2d() {
		...
		lbl = new JLabel("Bins in x: ");
		pnl2d.add(lbl);
		pnl2d.add(txt_bins_x_2d);
		JToggleButton togBinsX1 = new JToggleButton("Number of bins");
		JToggleButton togBinsX2 = new JToggleButton("Step Size");
		
		togBinsX1.addActionListener(new ActionListener() {
			@Override
		...
		togBinsX2.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				bool_binsInX = false;
			}
		...
		JToggleButton togBinsY1 = new JToggleButton("Number of bins");
		JToggleButton togBinsY2 = new JToggleButton("Step Size");
		pnl2d.add(togBinsY1);
		pnl2d.add(togBinsY2);
		...
		togBinsY1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				bool_binsInY = true;
			}
		...
		togBinsY2.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				bool_binsInY = false;
			}
		...
		JButton btnProcessSeries = new JButton("Process series of histograms");
		
		pnl2d.add(btnProcessSeries);
		pnl2d.add(new JLabel());
		pnl2d.add(new JLabel());
		
		final JButton btnCreate = new JButton("Create 2d Histogram");
		btnCreate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				histo_2d.setBinsInX(bool_binsInX);
				histo_2d.setBinsInY(bool_binsInY);
				if(bool_binsInX)
					histo_2d.set_bin_num_x(Integer.valueOf(txt_bins_x_2d.getText()));
				else
					histo_2d.set_bin_step_x(Double.valueOf(txt_bins_x_2d.getText()));
				if(bool_binsInY)
					histo_2d.set_bin_num_y(Integer.valueOf(txt_bins_y_2d.getText()));
				else
					histo_2d.set_bin_step_y(Double.valueOf(txt_bins_y_2d.getText()));
				
				histo_2d.createHistogram();
			}
		});
		final JButton btnDisplay = new JButton("Display 2d Histogram");
		...
		btnProcessSeries.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
//				open file
				chooser.setDialogTitle("Open 2d histogram data");
...
//					save histo image
						...
						try {
						    BufferedImage bi = pnlImage.getBufferedImage();
						    ImageIO.write(bi, "png", file_save_pic_histo_2d);
						} catch (IOException ioe) {
							JOptionPane.showMessageDialog(null, "Save file not accessible.", "File access error",
									JOptionPane.ERROR_MESSAGE);
						}
