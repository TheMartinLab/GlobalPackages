...
public class DiffractionPatternTest {
	...
	public void run() {
		...
		JAtom[] someAtoms = (new ReadATD(new File("C:\\Users\\Eric-t61p\\Downloads\\CZX1-cat.atd"))).getAtoms();
		
		BravaisLattice test = BravaisLatticeFactory.getLattice(BravaisLattice.CUBIC, new double[] {a}, someAtoms);
