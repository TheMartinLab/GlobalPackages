...
public class CubicModel extends RegressionModel {

	private double kA, t0, n;
	/**
	 * 
	 ...
	 */
	public CubicModel(double[] parameters, boolean[] isFittable, Bounds[] parameterBounds) {
	...
	public void setSpecificParameter(double parameter,
		...
		case n:
			...
			break;
		default:
			throw new ParameterSelectionException("The options for the Cubic model are kA, t0 and n.  Your selection of: " +
	...
	public String getModelName() { return "Cubic"; }
	public String getModelEquation() { return "alpha(t) = (kA * (t-t0) ) ^ n"; }
	public String getModelEquationWithParameters() { return "alpha(t) = (" + kA + "* (t-" + t0 + ") ) ^ " + n; }
