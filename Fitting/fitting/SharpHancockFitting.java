...
public class SharpHancockFitting {

	private double[][] timeAndData;
	private Equation1 e;
	private boolean limitX = false, limitY = false;
	private double minX, maxX, minY, maxY;
	private int ERROR_CODE = 0;
	public SharpHancockFitting(double[][] timeAndData, Equation1 e) {
	...
	private boolean withinLimits_X(double x) {
		if(!limitX) { return true; }
		if(x > minX && x <= maxX) { return true; }
		return false;
	}
	private boolean withinLimits_Y(double y) {
